...
#ifndef ELANG_ASM_LOOP_INSTRUCTION_H
#define ELANG_ASM_LOOP_INSTRUCTION_H

#include "asm_instruction_object.h"

namespace elang::easm{
	class loop_instruction : public instruction_object{
	public:
		template <typename... args_types>
		explicit loop_instruction(args_types &&... args)
			: instruction_object(std::forward<args_types>(args)...){}

		virtual ~loop_instruction() = default;
	...
	protected:
		virtual byte_code::id get_opcode_() const override{
			return offset_opcode_(byte_code::id::loopb);
		}
...
#endif /* !ELANG_ASM_LOOP_INSTRUCTION_H */
