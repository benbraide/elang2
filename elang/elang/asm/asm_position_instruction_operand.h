...
#ifndef ELANG_ASM_POSITION_INSTRUCTION_OPERAND_H
#define ELANG_ASM_POSITION_INSTRUCTION_OPERAND_H

#include "asm_instruction_operand_object.h"

namespace elang::easm{
	class position_instruction_operand : public instruction_operand_object{
	public:
...
#endif /* !ELANG_ASM_POSITION_INSTRUCTION_OPERAND_H */
